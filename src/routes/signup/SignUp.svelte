        ...
        <div class="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                <form class="card-body" on:submit|preventDefault="{handleSignUp}">
                    ...
                    <div class="form-control">
                        ...
                        <input id="email" type="email" placeholder="email" class="input input-bordered" required bind:value="{email}"/>
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <input id="username" type="text" minlength=2 placeholder="username" class="input input-bordered" required bind:value="{username}"/>
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <input id="firstname" type="text" placeholder="name" class="input input-bordered" required bind:value="{firstname}"/>
                    </div>
                    ...
                    <div class="form-control">
                        ...
                        <input id="lastname" type="text" placeholder="name" class="input input-bordered" required bind:value="{lastname}"/>
                    </div>
                    ...
                    <label class="label" for="login">
                        <a href="/app" id="login" class="label-text-alt link link-hover">Already a user? Log In</a>
                    </label>
